...
const Footer = () => {
  return (
    <div className="bg-gradient-to-br from-zinc-100 to-zinc-200 dark:from-gray-900 dark:to-gray-800 border-t border-zinc-300 dark:border-gray-700 py-12 mt-auto">
      <MaxWidthWrapper className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 lg:px-10">
        ...
        <div className="flex flex-col space-x-4 space-y-3 ">
          <div className="flex items-center gap-1">
            ...
            <p className="font-semibold text-gray-800 dark:text-gray-200">Vertica Healthcare</p>
          </div>
            ...
            {footerSocilalMedia.map((social, index) => (
              <div key={index} className="relative">
                <a
                  ...
                  className="flex items-center space-x-3 p-3 rounded-xl hover:shadow-lg transition-all duration-300 group hover:scale-105 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50"
                >
        ...
        <MaxWidthWrapper>
          <div className="text-center">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              © {new Date().getFullYear()} Vertica Healthcare. All rights reserved. Made with ❤️ for better healthcare.
            </p>
          </div>
        </MaxWidthWrapper>
      </div>
