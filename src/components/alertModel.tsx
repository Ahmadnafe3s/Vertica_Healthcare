...
const AlertModel = ({ cancel, continue: continueAction }: alertModelProps) => {
  ...
  return (
    <>
      <div onClick={cancel} className='fixed top-0 left-0 h-screen w-full transition-all z-[120]' style={{ background: '#0000009c' }}></div>

      <div className="fixed flex flex-col gap-2 rounded-md ring-1 p-2.5 ring-gray-200 shadow-lg w-[300px] bg-white top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] z-[200]">
