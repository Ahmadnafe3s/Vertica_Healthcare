...
const RectCard = ({ path, name, amount, visits, children }: rectCardProps) => {
    return (
        <div className="mx-auto w-full ">
            <Link to={{
                pathname: path
            }} className='flex items-center gap-x-4 p-2.5 bg-white dark:bg-background active:scale-95 rounded-lg ring-1 transition-all ring-gray-200 dark:ring-zinc-800 hover:shadow-lg dark:shadow-zinc-900'>
                {children}
