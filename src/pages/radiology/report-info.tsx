...
const RadioReportInfo = ({ excludeActions = false, isOpen, onClose, onDelete, ID }: Props) => {

    const { reportForm, setReportForm, onReportSubmit, reportDetails, getRadiologyReportById } = useRadiology()

    useEffect(() => {
        if (ID) getRadiologyReportById(ID)
    }, [isOpen, ID])
    ...
    return (
        <>
            ...
            {reportForm && <RadiologyReportForm
...
export default RadioReportInfo