...
interface AddChargesFormModelProps extends HTMLAttributes<HTMLDivElement> {
    ...
    isPending: boolean,
    editDetails: RadiologyTestNameDetailsType
}


const CreateRadioTest = ({ editDetails, Submit, isPending, ...props }: AddChargesFormModelProps) => {
    ...
    const { register, setValue, reset, control, handleSubmit, formState: { errors } } = useForm<z.infer<typeof TestNameFormSchema>>({
        ...
        defaultValues: editDetails ? { ...editDetails, parameters: editDetails.RadioTestNameParameter } : ParameterDefaultValue
    })
