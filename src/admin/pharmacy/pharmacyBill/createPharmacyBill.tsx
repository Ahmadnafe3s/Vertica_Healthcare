        ...
        <ScrollArea className='h-[60vh] sm:h-[55vh]'>
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-3 gap-5 mb-8 px-2.5">
            ...
            {medicineField.map((medicine, index) => {
              ...
              return <section key={medicine.id} className="sm:col-span-full mt-2 p-2 rounded-md grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 border-2 border-dashed border-gray-200">
